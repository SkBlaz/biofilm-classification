...
COPY src/create_final_df_from_results.py src/feature_generator.py src/create_joint_df.py src/analysis.py src/run_analysis.sh src/feature_ranking_lite.py src/inference.py ./
